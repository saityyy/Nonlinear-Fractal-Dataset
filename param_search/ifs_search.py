...
parser.add_argument("--nonlinear", default="false", type=bool, help="flag to use nonlinear function")
...
def generator(params, nonlinear_flag):
    generators = ifs_function(prev_x=0.0, prev_y=0.0, nonlinear_flag=False)
    for param in params:
...
if __name__ == "__main__":
    ...
    while(class_num < args.category):  # class
        ...
        fracral_img = generator(params, args.nonlinear)
